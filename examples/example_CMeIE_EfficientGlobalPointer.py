...
class Module(pl.LightningModule):
    def __init__(self, plm_model, tokenizer, **kwargs):
        ...
        self.mention = EfficientGlobalPointer(self.hidden_size, 64, 2, mask_tril=True)
        self.head_idx = EfficientGlobalPointer(self.hidden_size, 64, self.hparams.num_labels, use_pe=False)
        self.tail_idx = EfficientGlobalPointer(self.hidden_size, 64, self.hparams.num_labels, use_pe=False)
